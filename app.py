...
# ========== DATOS ==========
data = {
    "Barrier": ['A2', 'A1', 'I2', 'S1', 'I1', 'S2', 'G4', 'G2', 'G1', 'F1', 'I5', 'G5'],
    "SHAP": [0.383, 0.383, 0.387, 0.392, 0.404, 0.421, 0.426, 0.454, 0.476, 0.481, 0.506, 0.694],
    "Out_Degree": [4.00, 8.91, 11.33, 3.91, 9.01, 3.55, 5.41, 12.25, 2.91, 11.73, 13.26, 16.93],
    "Betweenness": [0.033, 0.114, 0.071, 0.133, 0.039, 0.065, 0.005, 0.093, 0.026, 0.013, 0.026, 0.392]
}
